...
def add_carregador(form: CarregadorSchema):
    """Adiciona um novo Carregador no estoque
...
def get_carregadores():
    ...
    if not carregadores:
        # Caso não haja carregadores cadastrados no estoque
...
def del_carregador(query: CarregadorDelSchema):
    """Remove um Carregador do estoque a partir do seu ID
    ...
    if count:
        ...
        error_msg = "Carregador não cadastrado no estoque!!!"
